...
#' 
#' @param se SummarizedExperiment: generated by the 'ropls::opls' modeling
#' @param model.c character(1): name of the model to be plotted; use 'names(ropls::getOpls(se))'
...
#' @param label.c character(1): name of the colData column to be used for the labels
#' @param color.c character(1): name of the colData column to be used for the colors
...
#' @param info.vc character(): names of the colData columns to be used for the plotly info;
...
gg_scoreplot <- function(se,
  ...
  ropls_model.ls <- ropls::getOpls(se)
  stopifnot(model.c %in% names(ropls_model.ls))
  ropls.model <- ropls_model.ls[[model.c]]
  
  ## dataset
  
  pdata.df <- as.data.frame(SummarizedExperiment::colData(se))
  
  data.df <- cbind.data.frame(.names = colnames(se),
                              pdata.df,
